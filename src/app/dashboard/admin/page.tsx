...
import CobranzaManager from "@/components/CobranzaManager";
...
// ═══════════════════════════════════════════════════════════════════════════════
    ...
    return (
        <div style={{ padding: "1.5rem 2rem", minHeight: "100vh", fontFamily: "Inter,system-ui,sans-serif" }}>
            ...
            {/* ── MODAL DE ADMINISTRACIÓN DE COBRANZAS (REFACTORIZADO V2) ── */}
            {/* 
                ⚠️ CÓDIGO LEGACY REEMPLAZADO (originalmente líneas 2799-3610):
                Este bloque fue refactorizado a un componente separado: CobranzaManager.tsx
